...
const plans = [
  { name: 'Free', price: '$0/mo', features: ['100 transmissions/mo', 'DTN protocol only', 'Basic orbit calculations', 'Community support'] },
  { name: 'Pro', price: '$499/mo', features: ['Unlimited transmissions', 'DTN + CCSDS + model-diff (20x compression)', 'Kepler orbital mechanics', 'Mission management', 'Light delay optimization', 'Priority support'] },
  { name: 'Enterprise', price: 'Custom', features: ['Unlimited everything', 'Deep-space relay network', 'Custom protocols', 'Ground station integration', 'SLA 99.99%', 'Dedicated support'] },
];
